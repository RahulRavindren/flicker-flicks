...
object PreferenceManager {
    ...
    fun savePreference(preferenceType: PreferenceType?, key: String, value: Any) {
        savePreference(Utils.application, preferenceType, key, value)
    }
    ...
    fun savePreferenceIfChanged(savedPreference: SavedPreference, value: Any?): Boolean {
        ...
        if (value is String) {
            val savedPref = getPreference<String>(savedPreference, C.EMPTY_STRING)
    ...
    fun getString(key: String): String {
        return getString(key, C.EMPTY_STRING)
    }
